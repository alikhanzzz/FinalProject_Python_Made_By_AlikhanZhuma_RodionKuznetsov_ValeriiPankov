...
class Ui_weekendWindow(object):
    def setupUi(self, weekendWindow):
        ...
        weekendWindow.setObjectName("weekendWindow")
        weekendWindow.resize(960, 540)
        weekendWindow.setMinimumSize(QtCore.QSize(960, 540))
        weekendWindow.setMaximumSize(QtCore.QSize(960, 540))
        weekendWindow.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0.125 rgba(0, 0, 0, 255), stop:1 rgba(249, 162, 30, 255));")
        self.centralwidget = QtWidgets.QWidget(weekendWindow)
...
"border-radius: 1em;")
        ...
        self.weekendLogo = QtWidgets.QLabel(self.centralwidget)
        self.weekendLogo.setGeometry(QtCore.QRect(30, 30, 300, 300))
        self.weekendLogo.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"")
        self.weekendLogo.setText("")
        self.weekendLogo.setPixmap(QtGui.QPixmap("Images/TheWeekend.jpg"))
        self.weekendLogo.setScaledContents(True)
        self.weekendLogo.setObjectName("weekendLogo")
        self.theText = QtWidgets.QLabel(self.centralwidget)
        self.theText.setGeometry(QtCore.QRect(0, 335, 360, 45))
        font = QtGui.QFont()
        ...
        self.theText.setFont(font)
        self.theText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.theText.setAlignment(QtCore.Qt.AlignCenter)
        self.theText.setWordWrap(False)
        self.theText.setIndent(-1)
...
"color: rgb(255, 255, 255);")
        ...
        self.weekendText = QtWidgets.QLabel(self.centralwidget)
        self.weekendText.setGeometry(QtCore.QRect(0, 375, 360, 45))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        font.setPointSize(36)
        font.setBold(True)
        font.setWeight(75)
        self.weekendText.setFont(font)
        self.weekendText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.weekendText.setAlignment(QtCore.Qt.AlignCenter)
        self.weekendText.setObjectName("weekendText")
        self.frameLeftBack.raise_()
        self.frameRight.raise_()
        self.frameLeft.raise_()
        self.weekendLogo.raise_()
        self.theText.raise_()
        ...
        weekendWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(weekendWindow)
        QtCore.QMetaObject.connectSlotsByName(weekendWindow)
        ...
        self.music_files = [
                ("TheWeekend Music/The Weeknd - Call Out My Name.mp3", "Call Out My Name", 228),
                ("TheWeekend Music/The Weeknd - Blinding Lights.mp3", "Blinding Lights", 201),
                ("TheWeekend Music/The Weeknd - Save Your Tears.mp3", "Save Your Tears", 215),
                ("TheWeekend Music/The Weeknd - Die For You.mp3", "Die For You", 260),
                ("TheWeekend Music/The Weeknd, Gesaffelstein - I Was Never There.mp3", "I Was Never There (Gesaffelstein)", 241),
                ("TheWeekend Music/The Weeknd feat. Daft Punk - Starboy.mp3", "Starboy (Daft Punk)", 230),
                ("TheWeekend Music/The Weeknd - The Hills.mp3", "The Hills", 242),
                ("TheWeekend Music/The Weeknd - Reminder.mp3", "Reminder", 218),
                ("TheWeekend Music/The Weeknd - Party Monster.mp3", "Party Monster", 251),
                ("TheWeekend Music/The Weeknd, Playboi Carti, Madonna - Popular.mp3", "Popular (Playboi Carti & Madonna)", 215),
        ]
        ...
        weekendWindow.setWindowIcon(app_icon)
    def retranslateUi(self, weekendWindow):
        # Здесь задаются названия текстов.
        _translate = QtCore.QCoreApplication.translate
        weekendWindow.setWindowTitle(_translate("weekendWindow", "The Weekend (Album)"))
        self.theText.setText(_translate("weekendWindow", "The"))
        self.nowPlayingText.setText(_translate("weekendWindow", "Now Playing:"))
        self.weekendText.setText(_translate("weekendWindow", "Weekend"))
    def play_music(self):
