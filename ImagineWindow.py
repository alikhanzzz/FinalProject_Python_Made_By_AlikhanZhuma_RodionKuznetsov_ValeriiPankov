...
class Ui_imagineWindow(object):
    def setupUi(self, imagineWindow):
        ...
        imagineWindow.setObjectName("imagineWindow")
        imagineWindow.resize(960, 540)
        imagineWindow.setMinimumSize(QtCore.QSize(960, 540))
        imagineWindow.setMaximumSize(QtCore.QSize(960, 540))
        imagineWindow.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0.125 rgba(0, 0, 0, 255), stop:0.3 rgba(208, 25, 50, 255), stop:0.475 rgba(245, 233, 28, 255), stop:0.65 rgba(33, 151, 43, 255), stop:0.825 rgba(51, 216, 237, 255), stop:1 rgba(50, 43, 200, 255));")
        self.centralwidget = QtWidgets.QWidget(imagineWindow)
...
"border-radius: 1em;")
        ...
        self.imagineLogo = QtWidgets.QLabel(self.centralwidget)
        self.imagineLogo.setGeometry(QtCore.QRect(30, 30, 300, 300))
        self.imagineLogo.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"")
        self.imagineLogo.setText("")
        self.imagineLogo.setPixmap(QtGui.QPixmap("Images/ImagineDragons.jpg"))
        self.imagineLogo.setScaledContents(True)
        self.imagineLogo.setObjectName("imagineLogo")
        self.imagineText = QtWidgets.QLabel(self.centralwidget)
        self.imagineText.setGeometry(QtCore.QRect(0, 335, 360, 45))
        font = QtGui.QFont()
        ...
        self.imagineText.setFont(font)
        self.imagineText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.imagineText.setAlignment(QtCore.Qt.AlignCenter)
        self.imagineText.setWordWrap(False)
        self.imagineText.setIndent(-1)
        self.imagineText.setObjectName("imagineText")
...
"color: rgb(255, 255, 255);")
        ...
        self.dragonsText = QtWidgets.QLabel(self.centralwidget)
        self.dragonsText.setGeometry(QtCore.QRect(0, 375, 360, 45))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        font.setPointSize(32)
        font.setBold(True)
        font.setWeight(75)
        self.dragonsText.setFont(font)
        self.dragonsText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.dragonsText.setAlignment(QtCore.Qt.AlignCenter)
        self.dragonsText.setObjectName("dragonsText")
        self.frameLeftBack.raise_()
        self.frameRight.raise_()
        self.frameLeft.raise_()
        self.imagineLogo.raise_()
        self.imagineText.raise_()
        ...
        imagineWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(imagineWindow)
        QtCore.QMetaObject.connectSlotsByName(imagineWindow)
        ...
        self.music_files = [
                ("ImagineDragons Music/Imagine Dragons - Believer.mp3", "Believer", 204),
                ("ImagineDragons Music/Imagine Dragons - Thunder.mp3", "Thunder", 187),
                ("ImagineDragons Music/Imagine Dragons - Bones.mp3", "Bones", 165),
                ("ImagineDragons Music/Imagine Dragons, JID, Arcane, League Of Legends - Enemy.mp3", "Enemy (JID, Arcane & League Of Legends)", 173),
                ("ImagineDragons Music/Imagine Dragons - Demons.mp3", "Demons", 177),
                ("ImagineDragons Music/Imagine Dragons - Radioactive.mp3", "Radioactive", 188),
                ("ImagineDragons Music/Imagine Dragons - Natural.mp3", "Natural", 189),
                ("ImagineDragons Music/Imagine Dragons - Bad Liar.mp3", "Bad Liar", 260),
        ]
    ...
    def retranslateUi(self, imagineWindow):
        # Здесь задаются названия текстов.
        _translate = QtCore.QCoreApplication.translate
        imagineWindow.setWindowTitle(_translate("imagineWindow", "Imagine Dragons (Album)"))
        self.imagineText.setText(_translate("imagineWindow", "IMAGINE"))
        self.nowPlayingText.setText(_translate("imagineWindow", "Now Playing:"))
        self.dragonsText.setText(_translate("imagineWindow", "DRAGONS"))
    def play_music(self):
