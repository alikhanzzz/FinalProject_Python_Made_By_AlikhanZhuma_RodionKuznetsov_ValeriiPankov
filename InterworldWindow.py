...
class Ui_interworldWindow(object):
    def setupUi(self, interworldWindow):
        ...
        interworldWindow.setObjectName("interworldWindow")
        interworldWindow.resize(960, 540)
        interworldWindow.setMinimumSize(QtCore.QSize(960, 540))
        interworldWindow.setMaximumSize(QtCore.QSize(960, 540))
        interworldWindow.setStyleSheet("background-color: qlineargradient(spread:pad, x1:1, y1:0.5, x2:0, y2:0.5, stop:0.125 rgba(246, 149, 0, 255), stop:1 rgba(0, 0, 0, 255));")
        self.centralwidget = QtWidgets.QWidget(interworldWindow)
...
"border-radius: 1em;")
        ...
        self.interworldLogo = QtWidgets.QLabel(self.centralwidget)
        self.interworldLogo.setGeometry(QtCore.QRect(30, 30, 300, 300))
        self.interworldLogo.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"")
        self.interworldLogo.setText("")
        self.interworldLogo.setPixmap(QtGui.QPixmap("Images/InterWorld.jpg"))
        self.interworldLogo.setScaledContents(True)
        self.interworldLogo.setObjectName("interworldLogo")
        self.interworldText = QtWidgets.QLabel(self.centralwidget)
        self.interworldText.setGeometry(QtCore.QRect(0, 345, 360, 60))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        font.setPointSize(32)
        font.setBold(True)
        font.setWeight(75)
        self.interworldText.setFont(font)
        self.interworldText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.interworldText.setAlignment(QtCore.Qt.AlignCenter)
        self.interworldText.setObjectName("interworldText")
...
"color: rgb(255, 255, 255);")
        ...
        interworldWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(interworldWindow)
        QtCore.QMetaObject.connectSlotsByName(interworldWindow)
        ...
        self.music_files = [
                ("InterWorld Music/INTERWORLD - METAMORPHOSIS.mp3", "METAMORPHOSIS", 142),
                ("InterWorld Music/Interworld - METAMORPHOSIS (Sped Up).mp3", "METAMORPHOSIS (Sped Up)", 110),
                ("InterWorld Music/Interworld - METAMORPHOSIS 2.mp3", "METAMORPHOSIS 2", 137),
                ("InterWorld Music/INTERWORLD - METAMORPHOSIS 2 (Sped Up).mp3", "METAMORPHOSIS 2 (Sped Up)", 102),
                ("InterWorld Music/Interworld, zxcursed, Sadfriendd - METAMORPHOSIS 3.mp3", "METAMORPHOSIS 3", 128),
                ("InterWorld Music/Interworld, zxcursed, Sadfriendd - METAMORPHOSIS 3 (Sped Up).mp3", "METAMORPHOSIS 3 (Sped Up)", 109),
                ("InterWorld Music/Interworld - RAPTURE.mp3", "RAPTURE", 164),
                ("InterWorld Music/INTERWORLD - RAPTURE (Sped Up).mp3", "RAPTURE (Sped Up)", 123),
                ("InterWorld Music/INTERWORLD x MoonDeity - One Chance.mp3", "One Chance", 131),
                ("InterWorld Music/INTERWORLD - SOMNIUM.mp3", "SOMNIUM", 111),
        ]
    ...
    def retranslateUi(self, interworldWindow):
        # Здесь задаются названия текстов.
        _translate = QtCore.QCoreApplication.translate
        interworldWindow.setWindowTitle(_translate("interworldWindow", "INTERWORLD (Album)"))
        self.interworldText.setText(_translate("interworldWindow", "INTERWORLD"))
        self.nowPlayingText.setText(_translate("interworldWindow", "Now Playing:"))
    def play_music(self):
