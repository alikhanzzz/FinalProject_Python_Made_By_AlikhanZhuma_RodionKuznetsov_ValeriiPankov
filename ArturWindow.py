...
class Ui_arturWindow(object):
    def setupUi(self, arturWindow):
        ...
        arturWindow.setObjectName("arturWindow")
        arturWindow.resize(960, 540)
        arturWindow.setMinimumSize(QtCore.QSize(960, 540))
        arturWindow.setMaximumSize(QtCore.QSize(960, 540))
        arturWindow.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0.5, x2:1, y2:0.5, stop:0.125 rgba(0, 0, 0, 255), stop:1 rgba(200, 15, 12, 255));")
        self.centralwidget = QtWidgets.QWidget(arturWindow)
...
"border-radius: 1em;")
        ...
        self.arturLogo = QtWidgets.QLabel(self.centralwidget)
        self.arturLogo.setGeometry(QtCore.QRect(30, 30, 300, 300))
        self.arturLogo.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"")
        self.arturLogo.setText("")
        self.arturLogo.setPixmap(QtGui.QPixmap("Images/АртурПирожков.jpg"))
        self.arturLogo.setScaledContents(True)
        self.arturLogo.setObjectName("arturLogo")
        self.arturText = QtWidgets.QLabel(self.centralwidget)
        self.arturText.setGeometry(QtCore.QRect(0, 325, 360, 60))
        font = QtGui.QFont()
        ...
        self.arturText.setFont(font)
        self.arturText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.arturText.setAlignment(QtCore.Qt.AlignCenter)
        self.arturText.setWordWrap(False)
        self.arturText.setIndent(-1)
        self.arturText.setObjectName("arturText")
...
"color: rgb(255, 255, 255);")
        ...
        self.pirozhkovText = QtWidgets.QLabel(self.centralwidget)
        self.pirozhkovText.setGeometry(QtCore.QRect(0, 375, 360, 45))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        font.setPointSize(32)
        font.setBold(True)
        font.setWeight(75)
        self.pirozhkovText.setFont(font)
        self.pirozhkovText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.pirozhkovText.setAlignment(QtCore.Qt.AlignCenter)
        self.pirozhkovText.setObjectName("pirozhkovText")
        self.frameLeftBack.raise_()
        self.frameRight.raise_()
        self.frameLeft.raise_()
        self.arturLogo.raise_()
        self.arturText.raise_()
        ...
        arturWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(arturWindow)
        QtCore.QMetaObject.connectSlotsByName(arturWindow)
        ...
        self.music_files = [
                ("АртурПирожков Music/Артур Пирожков - Чика.mp3", "Чика", 217),
                ("АртурПирожков Music/Артур Пирожков - Деньги.mp3", "Деньги", 173),
                ("АртурПирожков Music/Артур Пирожков - Она решила сдаться.mp3", "Она решила сдаться", 207),
                ("АртурПирожков Music/Артур Пирожков - #Алкоголичка.mp3", "#Алкоголичка", 219),
                ("АртурПирожков Music/Артур Пирожков, Клава Кока - Хочешь.mp3", "Хочешь (Клава Кока)", 121),
                ("АртурПирожков Music/Артур Пирожков - Зацепила.mp3", "Зацепила", 219),
                ("АртурПирожков Music/Артур Пирожков - #КАКЧЕЛЕНТАНО.mp3", "#КАКЧЕЛЕНТАНО", 212),
                ("АртурПирожков Music/Артур Пирожков - #туДЫМ-сюДЫМ.mp3", "#туДЫМ-сюДЫМ", 202),
        ]
    ...
    def retranslateUi(self, arturWindow):
        # Здесь задаются названия текстов.
        _translate = QtCore.QCoreApplication.translate
        arturWindow.setWindowTitle(_translate("arturWindow", "Артур Пирожков (Album)"))
        self.arturText.setText(_translate("arturWindow", "Артур"))
        self.nowPlayingText.setText(_translate("arturWindow", "Now Playing:"))
        self.pirozhkovText.setText(_translate("arturWindow", "Пирожков"))
    def play_music(self):
