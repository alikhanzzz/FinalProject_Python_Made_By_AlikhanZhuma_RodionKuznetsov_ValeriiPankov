...
class Ui_hensonnWindow(object):
    def setupUi(self, hensonnWindow):
        ...
        hensonnWindow.setObjectName("hensonnWindow")
        hensonnWindow.resize(960, 540)
        hensonnWindow.setMinimumSize(QtCore.QSize(960, 540))
        hensonnWindow.setMaximumSize(QtCore.QSize(960, 540))
        hensonnWindow.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.125, y1:0.5, x2:1, y2:0.5, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(0, 240, 0, 255));\n"
"")
        self.centralwidget = QtWidgets.QWidget(hensonnWindow)
...
"border-radius: 1em;")
        ...
        self.hensonnLogo = QtWidgets.QLabel(self.centralwidget)
        self.hensonnLogo.setGeometry(QtCore.QRect(30, 30, 300, 300))
        self.hensonnLogo.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"border: 1px solid rgb(255, 255, 255);\n"
"")
        self.hensonnLogo.setText("")
        self.hensonnLogo.setPixmap(QtGui.QPixmap("Images/Hensonn.jpg"))
        self.hensonnLogo.setScaledContents(True)
        self.hensonnLogo.setObjectName("hensonnLogo")
        self.hensonnText = QtWidgets.QLabel(self.centralwidget)
        self.hensonnText.setGeometry(QtCore.QRect(30, 345, 300, 60))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        font.setPointSize(40)
        font.setBold(True)
        font.setWeight(75)
        self.hensonnText.setFont(font)
        self.hensonnText.setStyleSheet("background-color: rgba(0, 0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.hensonnText.setAlignment(QtCore.Qt.AlignCenter)
        self.hensonnText.setObjectName("hensonnText")
...
"color: rgb(255, 255, 255);")
        ...
        self.musicSlider.setGeometry(QtCore.QRect(380, 445, 550, 30))
...
"color: rgb(255, 255, 255);")
        ...
        hensonnWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(hensonnWindow)
        QtCore.QMetaObject.connectSlotsByName(hensonnWindow)
        ...
        self.music_files = [
                ("Hensonn Music/Hensonn - Sahara.mp3", "Sahara", 171),
                ("Hensonn Music/Hensonn - Sahara (Sped Up).mp3", "Sahara (Sped Up)", 131),
                ("Hensonn Music/Hensonn - Flare.mp3", "Flare", 152),
                ("Hensonn Music/Hensonn - Flare (Sped Up).mp3", "Flare (Sped Up)", 122),
                ("Hensonn Music/Hensonn - Control.mp3", "Control", 137),
                ("Hensonn Music/Hensonn - Control (Sped Up).mp3", "Control (Sped Up)", 126),
                ("Hensonn Music/Hensonn - Scape.mp3", "Scape", 147),
                ("Hensonn Music/Hensonn - Scape (Sped Up).mp3", "Scape (Sped Up)", 130),
                ("Hensonn Music/Hensonn - Fear.mp3", "Fear", 131),
                ("Hensonn Music/Hensonn - Fear (Sped Up).mp3", "Fear (Sped Up)", 118),
        ]
    ...
    def retranslateUi(self, hensonnWindow):
        # Здесь задаются названия текстов.
        _translate = QtCore.QCoreApplication.translate
        hensonnWindow.setWindowTitle(_translate("hensonnWindow", "Hensonn (Album)"))
        self.hensonnText.setText(_translate("hensonnWindow", "Hensonn"))
        self.nowPlayingText.setText(_translate("hensonnWindow", "Now Playing:"))
    def play_music(self):
